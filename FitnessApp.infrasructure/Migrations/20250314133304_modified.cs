        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    CreatedByNutritionistId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NutritionPlans_Nutritionists_CreatedByNutritionistId",
                        column: x => x.CreatedByNutritionistId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LevelId = table.Column<int>(type: "int", nullable: false),
                    CreatedByTrainerId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkoutProgram_Levels_LevelId",
                        column: x => x.LevelId,
                        principalTable: "Levels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkoutProgram_Trainers_CreatedByTrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trainees_NutritionPlans_NutritionPlanId",
                        column: x => x.NutritionPlanId,
                        principalTable: "NutritionPlans",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkoutSessions_WorkoutProgram_WorkoutProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Calories = table.Column<int>(type: "int", nullable: false),
                    Proteins = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TraineeWorkoutPrograms", x => new { x.TraineeId, x.WorkoutProgramId });
                    table.ForeignKey(
                        name: "FK_TraineeWorkoutPrograms_Trainees_TraineeId",
                        column: x => x.TraineeId,
                        principalTable: "Trainees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TraineeWorkoutPrograms_WorkoutProgram_WorkoutProgramId",
                        column: x => x.WorkoutProgramId,
                        principalTable: "WorkoutProgram",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NutritionPlans_CreatedByNutritionistId",
                table: "NutritionPlans",
                column: "CreatedByNutritionistId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trainees_NutritionPlanId",
                table: "Trainees",
                column: "NutritionPlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TraineeWorkoutPrograms_WorkoutProgramId",
                table: "TraineeWorkoutPrograms",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkoutProgram_CreatedByTrainerId",
                table: "WorkoutProgram",
                column: "CreatedByTrainerId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkoutProgram_LevelId",
                table: "WorkoutProgram",
                column: "LevelId");
